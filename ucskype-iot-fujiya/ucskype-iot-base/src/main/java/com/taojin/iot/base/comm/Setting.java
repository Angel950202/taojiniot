...
public class Setting implements Serializable {
	...
	/**
	 * 话机挂断事件定义
	 * 注意：数组顺序不可随意改动,报表分析根据此数组进行匹配
	 */
	public static String[] hangupcauses = {
		"SUCCESS",//呼叫成功
		"USE_CALL_BACK",//回拨第一路呼叫
		"NO_ANSWER",//超时落地无应答
		"ORIGINATOR_CANCEL",//主叫挂断
		"SUBSCRIBER_ABSENT",//非法呼叫
		"NO_USER_RESPONSE",//落地返回480
		"nibble_nil",//账户余额不足或者没有被叫对应的费率
		"NIBBLE_IS_NULLORLOCK",//费率不存在或不可用
		"FIND_PHONE_ERROR",//话机查找失败
		"NOT_ENOUGH_MONEY",//余额不足
		"INVALID_GATEWAY",//非法网关
		"USER_NOT_REGISTERED",//话机不在线
		"RECOVERY_ON_TIMER_EXPIRE",
		"USER_BUSY ",//用户忙
		"CALL_REJECTED",//被叫拒接
		"Gateway_nil",//网关为空(1.0)
		"GATEWAY_NULL",//网关为空(2.0)
		"call_nil",//主叫或被叫为空(1.0)
		"CALL_NUM_NULL",//主叫或被叫为空(2.0)
		"FEETYPE_GREATER_CALLLEVEL",//费率等级大于呼叫等级
		"call_prefix_forbid",//对接前缀非法
		"call_transform_err"};//对接前缀转换错误
	
	/**
	 * 话机挂断事件定义
	 * 注意：数组顺序不可随意改动,报表分析根据此数组进行匹配
	 */
	public static String[] hangupcauseNames = {
		"呼叫成功",
		"回拨第一路呼叫",
		"超时落地无应答",
		"主叫挂断",
	...
	/**是否允许对接网关登录*/
	private Boolean isMapGatewayLogin;
	/**是否允许结算网关登录*/
	...
	@NotNull
	public Boolean getIsAccountLogin() {
		return isAccountLogin;
	}
	public void setIsAccountLogin(Boolean isAccountLogin) {
		this.isAccountLogin = isAccountLogin;
	}
	
	@NotNull
	public Boolean getIsMapGatewayLogin() {
		return isMapGatewayLogin;
	}
	public void setIsMapGatewayLogin(Boolean isMapGatewayLogin) {
		this.isMapGatewayLogin = isMapGatewayLogin;
	}
	
	@NotNull
	public Boolean getIsGatewayLogin() {
		return isGatewayLogin;
	}
	public void setIsGatewayLogin(Boolean isGatewayLogin) {
		this.isGatewayLogin = isGatewayLogin;
	}
	...
	@NotNull
	public Boolean getInernalIsOpen() {
		return inernalIsOpen;
	}
	public void setInernalIsOpen(Boolean inernalIsOpen) {
		this.inernalIsOpen = inernalIsOpen;
	}
