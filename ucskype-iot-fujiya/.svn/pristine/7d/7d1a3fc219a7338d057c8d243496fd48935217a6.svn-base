...
public class CRC16M {
	 ...
	 * @return
	 */
	public static String doCrc16(String hex){
		byte[] sbuf = CRC16M.getSendBuf(hex);
...
//这里写入需要生成校验码的字符串
//		byte[] sbuf = CRC16M.getSendBuf("68A00102111820000050070AEEEEEEEEEEEEEEEEEEEE");
//		String ss = CRC16M.getBufHexStr(sbuf);//将字节转成字符串
//输出带有校验码的字符串
		System.out.println(doCrc16("68A4AAAAAAAAAAAAAA6000070000001810090001"));
	}
}
