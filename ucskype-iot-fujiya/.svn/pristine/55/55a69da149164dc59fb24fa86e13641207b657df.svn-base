 ...
 * ============================================================================
 */
@Repository("equipmentIpaddressDaoImpl")
public class EquipmentIpaddressDaoImpl extends BaseDaoImpl<EquipmentIpaddress,Long> implements EquipmentIpaddressDao{
