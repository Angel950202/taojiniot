 ...
 * ============================================================================
 */
@Repository("equipmentTriggerLogDaoImpl")
public class EquipmentTriggerLogDaoImpl extends BaseDaoImpl<EquipmentTriggerLog,Long> implements EquipmentTriggerLogDao{
