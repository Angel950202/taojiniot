 ...
 */
@Entity
@Table(name = "iot_plugin_config")
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "iot_plugin_config_sequence")
public class PluginConfig extends OrderEntity {
	...
	@CollectionTable(name = "iot_plugin_config_attribute")
