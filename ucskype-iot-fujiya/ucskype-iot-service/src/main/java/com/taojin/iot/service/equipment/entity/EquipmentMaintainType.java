 ...
 */
@Entity
@Table(name = "iot_equipment_maintain_type")
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "iot_equipment_maintain_type_sequence")
public class EquipmentMaintainType extends BaseEntity{
